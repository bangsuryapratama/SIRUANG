          ...
          <div class="col-sm-6 col-lg-4">
            <div class="card shadow-none bg-warning-subtle rounded-24">
              <div class="card-body text-center py-14">
                <img src="{{asset('assets/backend/images/frontend-pages/icon-briefcase.svg')}}" alt="icon">
            ...
            <div class="card shadow-none bg-secondary-subtle rounded-24">
              ...
              <div class="d-flex justify-content-center">
                <img src="{{asset('assets/backend/images/frontend-pages/playframe.png')}}" alt="icon">
              </div>
            </div>
          </div>
          <div class="col-lg-4 order-last order-lg-0">
            <div class="card shadow-none bg-primary-subtle rounded-24">
              <div class="card-body text-center py-14 px-3">
                ...
                <img src="{{asset('assets/backend/images/frontend-pages/screen.png')}}" alt="icon" class="img-fluid pb-2">
              </div>
            </div>
          </div>
          <div class="col-sm-6 col-lg-4">
            <div class="card shadow-none bg-secondary-subtle rounded-24">
              <div class="card-body text-center py-14">
                <img src="{{asset('assets/backend/images/frontend-pages/icon-speech-bubble.svg')}}" alt="icon">
            ...
            <div class="card shadow-none bg-danger-subtle rounded-24">
              <div class="card-body text-center pt-14 pb-5 mb-8">
                <img src="{{asset('assets/backend/images/frontend-pages/icon-favorites.svg')}}" alt="icon">
              ...
              <div class="row gap-lg-0 gap-7">
                <div class="col-lg-6">
                  <div class="bg-primary-subtle rounded-3 px-10 pt-5 pb-4">
                    <img src="{{asset('assets/backend/images/frontend-pages/tabsimage.png')}}" alt="icon" class="w-100">
                  </div>
                </div>
                <div class="col-lg-6">
    ...
    <section class="py-5 py-md-14 py-lg-12">
      <div class="container-fluid">
        ...
        <div class="owl-carousel leadership-carousel owl-theme mt-5">
          <div class="item">
            <div class="">
              <img src="{{asset('assets/backend/images/frontend-pages/alex.jpg')}}" alt="leader" class="rounded-3">
          ...
          <div class="item">
            <div class="">
              <img src="{{asset('assets/backend/images/frontend-pages/jordan.jpg')}}" alt="leader" class="rounded-3">
              <div class="position-relative leadership-card z-1 bg-white mt-n10 rounded py-3 px-8 mx-9 text-center shadow-sm">
          ...
          <div class="item">
            <div class="">
              <img src="{{asset('assets/backend/images/frontend-pages/taylor.jpg')}}" alt="leader" class="rounded-3">
              <div class="position-relative leadership-card z-1 bg-white mt-n10 rounded py-3 px-8 mx-9 text-center shadow-sm">
          ...
          <div class="item">
            <div class="">
              <img src="{{asset('assets/backend/images/frontend-pages/morgan.jpg')}}" alt="leader" class="rounded-3">
              <div class="position-relative leadership-card z-1 bg-white mt-n10 rounded py-3 px-8 mx-9 text-center shadow-sm">
          ...
          <div class="item">
            <div class="">
              <img src="{{asset('assets/backend/images/frontend-pages/kiana.jpg')}}" alt="leader" class="rounded-3">
              <div class="position-relative leadership-card z-1 bg-white mt-n10 rounded py-3 px-8 mx-9 text-center shadow-sm">
                <h4 class="fs-5 fw-semibold mb-2">Morgan Patel</h4>
                <p class="fs-3 mb-0">Lead Developer</p>
              </div>
            ...
            <div class="owl-carousel template-carousel owl-theme">
              <div class="item rounded overflow-hidden">
                <a target="_blank" href="../main/index.html">
                  <img src="{{asset('assets/backend/images/demos/demo-main.jpg')}}" alt="template">
                </a>
              </div>
              <div class="item rounded overflow-hidden">
                <a target="_blank" href="../dark/index.html">
                  <img src="{{asset('assets/backend/images/demos/demo-dark.jpg')}}" alt="template">
                </a>
              </div>
              <div class="item rounded overflow-hidden">
                <a target="_blank" href="../horizontal/index.html">
                  <img src="{{asset('assets/backend/images/demos/demo-horizontal.jpg')}}" alt="template">
                </a>
              </div>
              <div class="item rounded overflow-hidden">
                <a target="_blank" href="../minisidebar/index.html">
                  <img src="{{asset('assets/backend/images/demos/demo-minisidebar.jpg')}}" alt="template">
                </a>
              </div>
              <div class="item rounded overflow-hidden">
                <a target="_blank" href="../rtl/index.html">
                  <img src="{{asset('assets/backend/images/demos/demo-rtl.jpg')}}" alt="template">
                </a>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-5">
            <div class="">
              <h2 class="fs-10 fw-bolder mb-3">
                What our clients
                <br /> think
                <img src="{{asset('assets/backend/images/logos/favicon.png')}}" alt="icon"> about us?
              </h2>
              <p class="fs-4">
              ...
              <div class="owl-carousel testimonial-carousel owl-theme">
                <div class="item">
                  <div>
                    <div class="d-flex align-items-center gap-3 my-4">
                      <div>
                        <img src="{{asset('assets/backend/images/frontend-pages/user_1.png')}}" width="56" height="56" alt="user">
                      </div>
                ...
                <div class="item">
                  <div>
                    <div class="d-flex align-items-center gap-3 my-4">
                      <div>
                        <img src="{{asset('assets/backend/images/frontend-pages/user-2.png')}}" width="56" height="56" alt="user">
                      </div>
                ...
                <div class="item">
                  <div>
                    <div class="d-flex align-items-center gap-3 my-4">
                      <div>
                        <img src="{{asset('assets/backend/images/frontend-pages/user-3.png')}}" width="56" height="56" alt="user">
                      </div>
              ...
              <div class="card p-7 mb-0 rounded-3 border">
                ...
                <div class="my-sm-7 my-3 d-flex flex-column gap-3">
                  <div class="d-flex gap-2">
                    <img src="{{asset('assets/backend/images/frontend-pages/icon-circle-check.svg')}}" alt="">
                  ...
                  <div class="d-flex gap-2">
                    <img src="{{asset('assets/backend/images/frontend-pages/icon-circle-x.svg')}}" alt="">
        ...
        <div class="bg-primary-subtle rounded-3 position-relative overflow-hidden">
          <div class="row">
            ...
            <div class="col-lg-6 d-lg-block d-none">
              <img src="{{asset('assets/backend/images/frontend-pages/design-collection.png')}}" alt="banner" class="position-absolute develop-feature-rich">
            </div>
          </div>
        </div>
      </div>
