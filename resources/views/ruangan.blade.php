...
<div class="container py-5">
    ...
    <div class="row justify-content-center mb-4">
      <div class="col-lg-8">
        <div class="d-flex flex-wrap justify-content-center gap-2">
          ...
          <button class="btn btn-outline-primary btn-sm rounded-pill px-3 filter-btn" data-filter="kelas">
            <i class="bi bi-mortarboard me-1"></i> Ruang Kelas
          </button>
  ...
  <div class="row g-4" id="rooms-container">
    ...
    <div class="col-lg-4 col-md-6 room-item" data-category="{{ strtolower($ruangan->kategori ?? 'kelas') }}">
        ...
        <div class="position-relative">
          ...
          <div class="ratio ratio-16x9 image-container">
            <img src="{{ asset('storage/'.$ruangan->cover) }}" 
                 class="object-fit-cover w-100 h-100 room-image" 
                 alt="{{ $ruangan->nama }}">
          ...
          <div class="mb-4">
            ...
            <div class="d-flex flex-wrap gap-2">
              @foreach(explode(',', $ruangan->fasilitas) as $index => $fasilitas)
                @if($index < 3)
                <span class="badge bg-light text-dark border rounded-pill px-3 py-1 small facility-badge">
