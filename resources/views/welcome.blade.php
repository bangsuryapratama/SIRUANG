    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-6 mb-4 mb-lg-0">
          <h1 class="fw-bold display-3 text-primary mb-3">SIRUANG</h1>
          <p class="fs-5 text-muted mb-3">
            Sistem Penjadwalan Ruangan Kelas & Laboratorium.
          </p>
        ...
        <div class="col-lg-6 text-center">
          <div class="image-container position-relative">
            <img src="{{ asset('assets/backend/img/LAB.jpg') }}" alt="Ilustrasi Ruangan" class="img-fluid rounded-4 shadow-lg main-image">
